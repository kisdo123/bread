...
<body>
	<h3 style="text-align: center;">
		<a href="main.jsp" style="font-family: sans-serif; font-weight: bolder; text-decoration: none; font-size: 60px; color: #8B4F1D">BREAD</a>
	</h3>
	<br>
	<br>
	<br>
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					<div class="col-sm-12 text-center">
						...
						<button class="btn btn-danger" type="reset" onclick="location.href = 'main.jsp'">
